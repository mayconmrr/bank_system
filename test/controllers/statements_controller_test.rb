...
class StatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post statements_url, params: { statement: { account_id: @statement.account_id, balance: @statement.balance } }
    end
  ...
  test "should update statement" do
    patch statement_url(@statement), params: { statement: { account_id: @statement.account_id, balance: @statement.balance } }
